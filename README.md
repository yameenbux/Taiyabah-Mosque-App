...
| Translations | 1,846 strings in all three languages, nothing missing and nothing spare |
...
- the duʿā for sleeplessness, and the one said over Zam Zam, are in none of the
  six books. Ḥiṣn al-Muslim has no Zam Zam chapter either — that one belongs to
  a later popular tradition, not to the collection it is usually credited to
