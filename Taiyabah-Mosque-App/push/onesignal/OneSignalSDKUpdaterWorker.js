/* Compatibility copy — see push/onesignal/OneSignalSDKUpdaterWorker.js for the canonical one.
   ...
   names the GitHub Pages project subfolder: it requests
     ...
     /Taiyabah-Mosque-App/push/onesignal/OneSignalSDKUpdaterWorker.js
